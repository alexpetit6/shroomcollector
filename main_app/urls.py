...
urlpatterns = [
    ...
    path('shrooms/<int:shroom_id>/assoc_meal/<int:meal_id>/', views.assoc_meal, name='assoc_meal'),
    path('shrooms/<int:shroom_id>/remove_meal/<int:meal_id>/', views.remove_meal, name='remove_meal'),
